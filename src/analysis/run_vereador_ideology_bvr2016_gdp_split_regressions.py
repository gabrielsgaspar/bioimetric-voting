...
OUTPUT_DIR = ROOT / "resources" / "regressions" / "tse_vereador_ideology_bvr2016_gdp_split"
RESULTS_PATH = OUTPUT_DIR / "bvr2016_never_vereador_ideology_gdp_split_regressions.csv"
STANDARDIZED_RESULTS_PATH = OUTPUT_DIR / "bvr2016_never_vereador_ideology_gdp_split_regressions_zscore.csv"
SAMPLE_PATH = OUTPUT_DIR / "bvr2016_never_vereador_ideology_gdp_split_sample.csv"
DIAGNOSTICS_PATH = OUTPUT_DIR / "bvr2016_never_vereador_ideology_gdp_split_diagnostics.csv"
...
def build_sample() -> tuple[pd.DataFrame, float]:
    ...
    sample = vereador.merge(build_status(), on="municipality_id", how="inner")
